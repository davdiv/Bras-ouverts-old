...
public class ComboBoxCellEditor extends CellRendererEditor<JXComboBox, Object> {

    public ComboBoxCellEditor(List items) {
        component = new JXComboBox(items.toArray());

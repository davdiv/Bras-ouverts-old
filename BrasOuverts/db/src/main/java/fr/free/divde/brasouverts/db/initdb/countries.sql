-- http://www.armetiz.info/pays-monde-sql/
...
(275, 'PS', 'PSE', 'Palestinská území', 'Palästinensische Autonomiegebiete', 'Palestinian Territory', 'Palestina', 'Territoire Palestinien', 'Territori Palestinesi', 'Palestina'),

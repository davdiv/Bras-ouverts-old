...
public class BrasOuvertsDB {
    ...
    public static EntityManagerFactory getEntityManagerFactory() {
        if (entityManagerFactory == null) {
            ...
            properties.put(PersistenceUnitProperties.JDBC_DRIVER, pref.get("javax.persistence.jdbc.driver", ""));
            properties.put(PersistenceUnitProperties.JDBC_URL, pref.get("javax.persistence.jdbc.url", ""));
            properties.put(PersistenceUnitProperties.JDBC_PASSWORD, pref.get("javax.persistence.jdbc.password", ""));
            properties.put(PersistenceUnitProperties.JDBC_USER, pref.get("javax.persistence.jdbc.user", ""));
            properties.put(PersistenceUnitProperties.DDL_GENERATION, pref.get("eclipselink.ddl-generation", "create-tables"));
            properties.put(PersistenceUnitProperties.CLASSLOADER, BrasOuvertsDB.class.getClassLoader());
